...
module.exports = async (inscribedData, repositories) => {
  ...
  if (!isStudentInExam) {
    throw new ResponseError(TYPES_ERROR.ERROR, 'El estudiante no está registrado en ese examen', 'student_not_registered');
  }

  return inscribedRepositoryMySQL.deleteInscribed(inscribedData);
};
